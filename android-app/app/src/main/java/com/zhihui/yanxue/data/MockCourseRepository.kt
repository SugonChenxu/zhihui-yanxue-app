...
object MockCourseRepository {
    ...
    val courses: List<Course> = listOf(
        ...
        // 事件
        Course("c008", "天津解放", "1949年1月15日天津解放的历史过程，讲述解放军英勇作战的故事。", "事件", "初高中生", "bg_course_8", duration = 40, studentCount = 1560, rating = 4.9f, tags = listOf("天津解放", "解放战争")),
        Course("c009", "五四运动在天津", "五四运动期间天津学生的爱国行动，包括罢课、游行等活动。", "事件", "大学生", "bg_course_9", duration = 35, studentCount = 890, rating = 4.7f, tags = listOf("五四运动", "学生运动"))
    )
