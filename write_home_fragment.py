...
# Write HomeFragment.kt
home_fragment = """package com.zhihui.yanxue.ui
...
base = r"D:\文档\项目\vibecoding\android-app\app\src\main\java\com\zhihui\yanxue\ui"
with open(os.path.join(base, "HomeFragment.kt"), "w", encoding="utf-8") as f:
    f.write(home_fragment)

print("HomeFragment.kt written successfully!")
